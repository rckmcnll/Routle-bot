...
BOT_HANDLE   = "pdxroutl.bsky.social"   # e.g. "routlebot.bsky.social"
BOT_PASSWORD = "9UE$vxt#)7zB#L\""       # Use an App Password from bsky Settings
...
NOTIFY_HANDLE = "rockom.bsky.social"
